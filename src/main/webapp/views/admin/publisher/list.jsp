...
<body>
	<div class="container-fluid px-4">
		<form action="<c:url value='/admin-book'/>" id="formSubmit"
			method="get">
			<h1 class="mt-4"><strong>PUBLISHERS MANAGER</strong></h1>
			<ol class="breadcrumb mb-4">
				<li class="breadcrumb-item active">Find, add, edit, and delete publishers.</li>
			</ol>
			<div class="card mb-4">
				...
				<div class="row">
					...
					<div class="col-md-3 mb-4">
						<a class="btn btn-outline-info" data-toggle="tooltip" title="Add new publisher" href='<c:url value="/admin-publisher?type=edit"/>'>
					...
					<table id="datatablesSimple">
						...
						<tbody>
							<c:forEach var="item" items="${publisher.resultList}">
								<c:set var="bookTitle" value="${item.name}" />
								<tr>
									<td>${item.id}</td>
									<td>${item.name}</td>
									<td>${item.headquarterLocation}</td>
									<td>
									
									<c:url var="editURL" value="/admin-publisher">
									  ...
									  <div class="modal-dialog modal-dialog-centered">
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        Are you sure you want to remove all the things related to Publisher ID = <a id="publisherID"></a>? This action cannot be undone.
									      </div>
		...
		function myfunction2(index) {
			data["id"] = index;
	 	    document.getElementById("publisherID").innerHTML = index; 
		}
